...
libmm-vidc-inc      += $(call project-path-for,qcom-media)/hardware/qcom/media/mm-core/inc
libmm-vidc-inc      += $(call project-path-for,qcom-media)/hardware/qcom/media/mm-video-v4l2/vidc/vdec/inc
libmm-vidc-inc      += $(call project-path-for,qcom-media)/hardware/qcom/media/libc2dcolorconvert
